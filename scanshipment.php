        ...
        <div style="padding-top: 10px; color: white;">
         ...
         <div class="customalert">
            <div class="alertcontent">
               ...
               <img id="qrious">
               <div id="bottomText" style="margin-top: 10px; margin-bottom: 5px;"> &nbsp </div>
      ...
      <center>
         ...
         <div class="greyarea">
            ...
            <form id="form2" autocomplete="off">
               ...
               <div><input type="hidden" class="forminput" id="user" value=<?php echo $_SESSION['username']; ?> required></div>
     ...
     <!--  <div class='box'>
      ...
      <script>
         ...
         $('#form1').on('submit', function(event) {
           ...
           username = $('#user').val(); 
           prodname=prodname+"<br>Updated By: "+username;
         ...
         $('#form2').on('submit', function(event) {
           ...
           var today = new Date();
           var thisdate = today.getFullYear()+'-'+(today.getMonth()+1)+'-'+today.getDate();
           var info = "<br><br>Updated By: "+user+"<br>Date: "+thisdate+"</b><br>Location: "+prodlocation;
           web3.eth.getAccounts().then(async function(accounts) {
