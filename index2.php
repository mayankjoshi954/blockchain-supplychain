...
<html lang="en">
  <head>
    ...
    <title>SupplyChain Decentralized App</title>
  ...
  <body class="area">
      ...
      <header id="header" class="header fixed-top" data-scrollto-offset="0" style="">
    <div style="background-color: #ffffff; margin-top: 0% " class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar" style="">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="index2.php">Signup</a></li>
        </ul>
        <i class="bi bi-list mobile-nav-toggle d-none"></i>
      </nav><!-- .navbar -->

      <a class="btn-getstarted scrollto" href="index2.php">Get Started</a>
  ...
  <center>
    ...
    <div style="width: 100%">
      ...
      <div class="loginformcard" id="card1" style="margin-top: 12%; background-image: linear-gradient(to top, #a8edea 0%, #fed6e3 100%);">
            <p style="font-size: 40px; max-width: 80%;">
              <br>
            <!-- If you are a frst time user click signup, otherwise click login to continue. -->
            Login/Signup
          </p>
          <div class="cardbtnarea">
              <button type="button" class="btn btn-outline-dark col-md-4" id="login" style="height: 100px;margin: 5%;">Login</button>          
              <button type="button" class="btn btn-outline-dark col-md-4" id="signup" style="height: 100px;">Signup</button>
          </div>
      </div>


      <div class="loginformcard" id="maincard3" style="margin-top: 10%; background-image: linear-gradient(to top, #a8edea 0%, #fed6e3 100%);">
      ...
      <div class="loginformcard" id="maincard2" style="margin-top: 12%; background-image: linear-gradient(to top, #a8edea 0%, #fed6e3 100%);">
      <h4> Login to your existing account</h4>
            ...
            <br>
            <p>Don't have an account?<a href="#" id="gotosignup"> Create a new account now</a></p>
            </form>
